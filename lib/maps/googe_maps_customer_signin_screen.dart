import 'package:boom_driver/maps/geolocation_service.dart';
...
class GoogleSignInCustomerScreen extends StatefulWidget {
  const GoogleSignInCustomerScreen({
    super.key,
  });

  @override
  State<GoogleSignInCustomerScreen> createState() =>
      _GoogleSignInCustomerScreenState();
}

class _GoogleSignInCustomerScreenState
    extends State<GoogleSignInCustomerScreen> {
  ...
  void initState() {
    getLatLong();
    _locationController.text = ""; // Set initial text to empty string
    super.initState();
  }
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          //the values we selected by the navigate the map cursor
                          Container(
                            margin: const EdgeInsets.only(
