...
class PersonalTrips extends StatefulWidget {
  const PersonalTrips({super.key});

  @override
  State<PersonalTrips> createState() => _PersonalTripsState();
}

class _PersonalTripsState extends State<PersonalTrips> {
  @override
